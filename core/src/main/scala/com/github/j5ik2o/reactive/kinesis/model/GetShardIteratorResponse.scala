...
final case class GetShardIteratorResponse(override val statusCode: Option[Int] = None,
  ...
  def withShardIterator(value: Option[String]): GetShardIteratorResponse = copy(shardIterator = value)
}
