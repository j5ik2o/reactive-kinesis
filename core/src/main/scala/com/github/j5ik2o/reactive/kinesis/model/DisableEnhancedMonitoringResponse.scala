...
final case class DisableEnhancedMonitoringResponse(override val statusCode: Option[Int] = None,
  ...
  def withStreamName(value: Option[String]): DisableEnhancedMonitoringResponse = copy(streamName = value)
